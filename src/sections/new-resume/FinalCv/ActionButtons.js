        ...
        <Stack spacing= {3} >
                  <IconButtonAnimate sx= {{ p: 0}}>
                    <Paper
                        ...
                        onClick= {handlePrint}
                        sx= {{
                            borderRadius: !hover ? '100%' : '20px',
                            width: hover ? '150px' : 45,
                            height: 45,
                            alignItems: 'center',
...
export function EmailButton ({componentRef}) {
    ...
    return (
        <Stack spacing= {3}>
            ...
            { openEmail && <EmailBox openEmail= {openEmail} setOpenEmail= {setOpenEmail} form= {form} setForm= {setForm} handleSendEmail= {handleSendEmail} loading= {loading} /> }
        </Stack>
    )
}
