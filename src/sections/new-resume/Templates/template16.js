import {Stack, Typography, Divider, Chip, Rating, Paper, Box, Grid, Avatar} from '@mui/material'
...
const Template16 = forwardRef(({color, user}, ref) => {

    const {contact, summary, experience, skills, hobbies, language, education, certificate, honors, reference} = user

    return (
        <Stack ref= {ref}>
            <Stack alignItems= 'center' justifyContent= 'center' sx= {{bgcolor: color,p: 3}}>
                <Box
                  variant= 'outlined'
                  sx= {{
                    bgcolor: 'transparent',
                ...
                <Typography variant= 'h3' sx= {{textTransform: 'uppercase', color: color && 'white'}}>
            ...
            {/* -------------------- */}
                ...
                <Stack spacing= {3} sx= {{bgcolor: color, py: 2, px: 1, color: color && 'white', border: !color && `1px solid grey`}}>
