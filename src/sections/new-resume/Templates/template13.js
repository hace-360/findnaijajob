import {Stack, Typography, Divider, Chip, Rating, Paper, Avatar,Box} from '@mui/material'
...
const Template13 = forwardRef(({color, user}, ref) => {
    ...
    return (
            <Stack spacing= {2} sx= {{p: 3}} ref= {ref}>
                ...
                <Stack direction= 'row' alignItems= 'center' spacing= {3} >
                    <Avatar 
                       sx ={{width: 130, height: 130, textTransform: 'uppercase'}} 
                       variant= 'rounded'
