...
const Template14 = forwardRef(({color, user}, ref) => {
    ...
    return (
            <Stack spacing= {2} ref= {ref}>
                ...
                <Stack alignItems= 'center' justifyContent= 'center' sx= {{bgcolor: color, paddingTop: 3, paddingBottom: 0.7}} >
                    <Typography variant= 'h2' sx= {{ textTransform: 'uppercase', color: color && 'white'}}>
                        {contact?.firstName} {' '} {contact.lastName}
                    </Typography>

                    <Stack spacing= {1} direction= 'row' alignItems= 'center' sx= {{color: color && 'white'}} divider= {<Divider flexItem orientation= 'vertical' sx= {{border: '0.5px solid'}} />}>
