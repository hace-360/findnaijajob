...
export const StatesFilter = memo(({setForm, form,label, value}) => {
...
export const IndustryFilter = memo(({setForm, form, value}) => {
  ...
  return (
    <Autocomplete
      ...
      onChange= {(e, value) => setForm({...form, company: {...form.company, industry: value || ''}})}
      sx= {{width: '100%'}}
      renderInput={(params) => 
        <TextField 
          fullWidth {...params}
...
export const CountryFilter = memo(({setForm, form,label, value}) => (
