...
export default function CareerLangdingConnections({ countries }) {
  ...
  const {data: mainCountries = [], error} = useSWR('/job/countries/count')
          ...
          <Grid item xs={12} md={4}>
            ...
            >
              ...
              <Typography sx={{ mt: 3, mb: 5, color: 'text.secondary' }}>
                All the available jobs by country.
              </Typography>
              <NextLink href={Routes.jobs}>
                <Button
                  size="large"
                  variant="contained"
      ...
      >
        <Slider ref={carouselRef} {...carouselSettings}>
          {countries.map((country, index) => (
            ...
            >
              <JobByCountryItem key={index} country={country} />
            </Box>
          ))}
        </Slider>
